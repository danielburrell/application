 ...
 *
 */
public class SpringExplicitAnnotationContextApplication {
    private static final Logger logger = LoggerFactory.getLogger(SpringExplicitAnnotationContextApplication.class);
    ...
    public void run(String configClass) {
        ...
        try {
            ClassLoader classLoader = SpringExplicitAnnotationContextApplication.class.getClassLoader();
    ...
    public static void main(String[] args) {
        new SpringExplicitAnnotationContextApplication().run(args[0]);
    }
